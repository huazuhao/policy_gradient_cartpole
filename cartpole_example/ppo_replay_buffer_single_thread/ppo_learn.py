...
def ppo_learn(replay_buffer,replay_buffer_reward,env,model,cov_matrix,model_optim):
    ...
    while True:
        ...
        for update_iteration in range(0,5):
            ...
            #     off_line_data = sampled_off_line_data[sampled_index]
            ...
            #     temp_loss1 = ratios*vanila_pg_loss
            #     temp_loss2 = torch.clamp(ratios,1-C.ppo_clip,1+C.ppo_clip)*vanila_pg_loss
