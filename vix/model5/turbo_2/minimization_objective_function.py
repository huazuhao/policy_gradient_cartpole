...
class minimization_objective_function():
    ...
    def __init__(self):
        ...
        self.init_search_space_dict = {
            ...
            'lambda_expon_1':[0.001,1],
            'lambda_expon_2':[0.001,1],
            'lambda_expon_3':[0.001,1],
            'lambda_expon_4':[0.001,1],
            'lambda_expon_5':[0.001,1],
        }
    ...
    def __call__(self,x):
        ...
        self.optimization_history.append(np.min(total_returns))
