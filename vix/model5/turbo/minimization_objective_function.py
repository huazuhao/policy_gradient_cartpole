...
class minimization_objective_function():
    ...
    def __init__(self):
        ...
        self.mean_optimization_history = []
        ...
        self.init_search_space_dict = {
            ...
            'lambda_expon_1':[0.001,20],
            'lambda_expon_2':[0.001,20],
            'lambda_expon_3':[0.001,20],
            'lambda_expon_4':[0.001,20],
            'lambda_expon_5':[0.001,20],
        }
        ...
        self.var_name_list.append('lambda_expon_5')
    ...
    def get_one_sample_score(self,q,free_parameters,seed_index):
        ...
        lambda_expons = [lambda_expon_1,lambda_expon_2,lambda_expon_3,lambda_expon_4,lambda_expon_5]
    ...
    def __call__(self,x):
        ...
        self.mean_optimization_history.append(np.mean(total_returns))
        mean_optimization_history = {}
        mean_optimization_history['history'] = self.mean_optimization_history
        #store the history
        cwd = os.getcwd()
        #cwd = os.path.join(cwd, 'data_folder')
        parameter_file = 'mean_optimization_history.json'
        cwd = os.path.join(cwd,parameter_file)
        with open(cwd, 'w') as statusFile:
            statusFile.write(jsonpickle.encode(mean_optimization_history))
