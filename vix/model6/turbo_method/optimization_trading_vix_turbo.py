...
class optimization_trading_vix_turbo():
    ...
    def __init__(self):
        ...
        self.init_search_space_dict = {
            ...
            'beta_6a':[0,20],
            'beta_6b':[0,20],
            'lambda_expon_0':[0.01,0.1],
            'lambda_expon_1':[0.01,1],
            'lambda_expon_2':[0.01,0.1],
            'lambda_expon_3':[0.01,0.1],
            'lambda_expon_4':[0.01,0.1],
        }
        ...
        self.var_name_list.append('cov_para_11')
        self.var_name_list.append('cov_para_12')
        self.var_name_list.append('cov_para_13')
        self.var_name_list.append('cov_para_14')
        self.var_name_list.append('cov_para_15')
        ...
        self.var_name_list.append('beta_6a')
        self.var_name_list.append('beta_6b')
        self.var_name_list.append('lambda_expon_0')
    ...
    def get_one_sample_score(self,q,free_parameters,seed_index):
        ...
        locol_env = trading_vix_non_random_seed.trading_vix_non_random_seed(seed_index)
    ...
    def __call__(self,x):
        ...
        optimization_objective = np.mean(total_returns) - np.std(total_returns) * 0.5
